...
module su.dom {
    ...
    export class Sandbox {
        ...
        constructor(readyCallback, config) {
        ...
        _createIframe() {
            var that = this,
                iframe: any = doc.createElement("iframe");
            ...
            if (browser.throwsMixedContentWarningWhenIframeSrcIsEmpty()) {
        ...
        _onLoadIframe(iframe) {
            ...
            if (!browser.supportsSandboxedIframes()) {
        ...
        _unset(object, property, value?, setter?) {
            ...
            if (!browser.crashesWhenDefineProperty(property)) {
                try {
                    var config: any = {
